        ...
        <div>
            {
                isInEdit
                    ? <MemeImageEditor />
                    : <div className={StringHelpers.joinClassNames(bootstrap.dFlex, bootstrap.justifyContentCenter)}><img src={uploadedImageSrc} /></div>
            }

            <div className={StringHelpers.joinClassNames(bootstrap.row, bootstrap.justifyContentCenter)}>
                <div className={StringHelpers.joinClassNames(BootstrapHelpers.formFieldClasses, bootstrap.dFlex, bootstrap.justifyContentAround)}>
                    {
                        isInEdit
                            ? (<Button icon="save" onClick={() => dispatch(MemeUploadActions.stopEditing())} type="primary">Save</Button>)
